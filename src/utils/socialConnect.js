...
async function socialConnect(mobile) {
	console.log("Checking connection for mobile:", mobile);
	...
	try {
		...
		const userPlaintextIdentifier = mobile;
		...
		if (remainingQuota < 1) {
			...
			const ONE_CENT_CUSD_WEI = 5000000000000000;
			try {
